...
const navtogglesmall = document.querySelector('.nav-toggler-for');
const navsmall = document.querySelector('.nav-for');
const menuholder = document.querySelector('.MenuHolder');
const maincontainer = document.querySelector('.main-container');
const fasTag = document.querySelector('.fas');

menuholder.addEventListener('click', () => {

    if (navtogglesmall.classList.contains('hide')) {
        navtogglesmall.style.display = 'inline';
        navtogglesmall.classList.add('small');
        navtogglesmall.classList.remove('hide')
        fasTag.textContent = 'Hide Menu';
    }
    else {

    }
    navtogglesmall.addEventListener('click', () => {
        navtogglesmall.style.display = 'none';
        navtogglesmall.classList.remove('small');
        navtogglesmall.classList.add('hide');
        fasTag.textContent = 'Show Menu';
    })
